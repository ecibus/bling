...
{
    public class AjaxByteReportFormPresenter : Presenter
    {
        private IAjaxView m_View;

        public AjaxByteReportFormPresenter (IAjaxView view)
	    {
            m_View = view;
	    }
        ...
        public void ViewReport(string reportName, string pdfName, string parameters)
        {
            try
            {
