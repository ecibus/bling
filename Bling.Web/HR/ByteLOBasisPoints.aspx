<%@ Page Title="" Language="C#" MasterPageFile="~/Bling.Master" AutoEventWireup="true" CodeBehind="ByteLOBasisPoints.aspx.cs" Inherits="Bling.Web.HR.ByteLOBasisPoints" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="js/ByteLOBasisPoints.js" type="text/javascript"></script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container1 showgrid1 inline2">
        ...
        <h1>Byte Loan Officer Basis Points</h1>
