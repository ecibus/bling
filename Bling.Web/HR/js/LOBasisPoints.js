...
function ViewLOBasisPointHistoryCallback() {
    thisButton.busy('hide');
    window.open('Report/BasisPointsHistory.pdf?r=' + Math.floor(Math.random() * 1001), 'Report');
}
...
function ViewLOBasisPointCurrentCallback() {
    thisButton.busy('hide');
    window.open('Report/BasisPointsCurrent.pdf?r=' + Math.floor(Math.random() * 1001), 'Report');
}
function ViewLoBpCurrentCallback(){
	thisButton.busy('hide');
	window.open('Report/LoBpCurrent.pdf?r=' + Math.floor(Math.random() * 1001), 'Report');
}
function ViewLoBpHistoryCallback(){
	thisButton.busy('hide');
	window.open('Report/LoBpHistory.pdf?r=' + Math.floor(Math.random() * 1001), 'Report');
}
$(function () {
