...
namespace Bling.Web.HR.Report {
    ...
    public class Crystal_Report1401K : ReportClass {
        
        public Crystal_Report1401K() {
        }
        ...
        public override string FullResourceName {
            get {
                return "Bling.Web.HR.Report.401K.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedCrystal_Report1401K : Component, ICachedReport {
        
        public CachedCrystal_Report1401K() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            Crystal_Report1401K rpt = new Crystal_Report1401K();
            rpt.Site = this.Site;
            return rpt;
        }
