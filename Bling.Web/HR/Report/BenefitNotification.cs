...
namespace Bling.Web.HR.Report {
    ...
    public class BenefitNotification : ReportClass {
        
        public BenefitNotification() {
        }
        
        public override string ResourceName {
            get {
                return "BenefitNotification.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "Bling.Web.HR.Report.BenefitNotification.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedBenefitNotification : Component, ICachedReport {
        
        public CachedBenefitNotification() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            BenefitNotification rpt = new BenefitNotification();
            rpt.Site = this.Site;
            return rpt;
        }
