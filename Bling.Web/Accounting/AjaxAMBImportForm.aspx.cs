...
{
    public partial class AjaxAMBImportForm : BasePage, IAjaxView
    {
        private AjaxAMBImportFormPresenter m_Presenter;
        ...
        {
            m_Presenter = new AjaxAMBImportFormPresenter(this);
            base.OnInit(e);
        }
