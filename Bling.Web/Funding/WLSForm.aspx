<%@ Page Title="" Language="C#" MasterPageFile="~/Bling.Master" AutoEventWireup="true" CodeBehind="WLSForm.aspx.cs" Inherits="Bling.Web.Funding.WLSForm" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="js/WLSForm.js" type="text/javascript"></script>   
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
<div class="container showgrid1 inline">
        <h1>Bank of Sierra CSV</h1>
        ...
        <div class="span-24">
            ...
            <input type="text" id="txtBatchNo" value="20" class="span-1" /><br />
        </div>
        ...
        <div class="span-24">
            ...
            <i>Obligation No must be 20 to be included in the result.</i>
        </div>
