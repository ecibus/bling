...
{
    public partial class AjaxCustomersBankForm : BasePage, IAjaxView
    {
        private AjaxCustomersBankFormPresenter m_Presenter;
        ...
        {
            m_Presenter = new AjaxCustomersBankFormPresenter(this);
            base.OnInit(e);
        }
