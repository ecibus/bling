...
{
    public partial class AjaxTexasCapitalForm: BasePage, IAjaxView
    {
        private AjaxTexasCapitalFormPresenter m_Presenter;
        ...
        {
            m_Presenter = new AjaxTexasCapitalFormPresenter(this);
            base.OnInit(e);
        }
