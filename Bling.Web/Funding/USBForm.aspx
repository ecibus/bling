<%@ Page Title="" Language="C#" MasterPageFile="~/Bling.Master" AutoEventWireup="true" CodeBehind="USBForm.aspx.cs" Inherits="Bling.Web.Funding.USBForm" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="js/USBForm.js" type="text/javascript"></script>   
</asp:Content>
...
<div class="container showgrid1 inline">
        ...
        <div class="span-24">
            ...
            <input type="text" id="txtBatchNo" value="30" class="span-1" /><br />
        </div>
