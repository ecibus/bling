...
{
    public partial class AjaxViewPointForm : BasePage, IAjaxView
    {
        private AjaxViewPointFormPresenter m_Presenter;
        ...
        {
            m_Presenter = new AjaxViewPointFormPresenter(this);
            base.OnInit(e);
        }
