<%@ Page Title="" Language="C#" MasterPageFile="~/Bling.Master" AutoEventWireup="true" CodeBehind="ViewPointForm.aspx.cs" Inherits="Bling.Web.Funding.ViewPointForm" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="js/ViewPointForm.js" type="text/javascript"></script> 
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container showgrid1 inline">
        ...
        <div class="span-24">
            ...
            <i>Obligation No must be 5 to be included in the result.</i>
        </div>
        <br /><br />
        <div class="span-24">
